...
class DogCardAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        val adapterLayout = when(layout){
            Layout.HORIZONTAL ->LayoutInflater.from(parent.context).inflate(
                vertical_horizontal_list_item,parent,false)
            Layout.VERTICAL ->LayoutInflater.from(parent.context).inflate(
                vertical_horizontal_list_item,parent,false)
            Layout.GRID ->LayoutInflater.from(parent.context).inflate(R.layout.grid_list_item,parent,false)
            else ->LayoutInflater.from(parent.context).inflate(vertical_horizontal_list_item,parent,false)
        }
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        holder.textAge.text = "Age: ${item.age}"
        // TODO: Get the data at the current position
        // TODO: Set the image resource for the current dog
        // TODO: Set the text for the current dog's name
        // TODO: Set the text for the current dog's age
        val resources = context?.resources
        holder.textHobb.text =resources?.getString(R.string.dog_hobbies,item.hobbies)
